...
{
	/* Starte rfid_main */
	rfid_main_id = k_thread_create(&rfid_main_data, rfid_main_stack,
				       K_THREAD_STACK_SIZEOF(rfid_main_stack), rfid_main, NULL,
				       NULL, NULL, RFID_MAIN_PRIORITY, 0, K_NO_WAIT);
}
