...
/* Todo: Die Zephyr Treiber unterstützen aktuell noch keine Powermodes für den STM32L100 sodass er nicht schlafen geht.
         Die Treiber müssen erweitert werden und die Powermodes im DTS aktiviert werden. Dann geht auch der STM32L100 in den Sleepmode
         Aktuell wird nur die externe peripherie abgeschaltet */
...
{
    k_timer_start(&sleep_timer, K_SECONDS(2), K_NO_WAIT);
