...
#endif
static const struct gpio_dt_spec jumper_spec = GPIO_DT_SPEC_GET_OR(JUMPER_NODE, gpios, {0});
...
void jumper_cb(const struct device *dev, struct gpio_callback *cb, uint32_t pins)
{
